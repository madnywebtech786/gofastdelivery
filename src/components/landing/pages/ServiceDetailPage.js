...
export const ALL_SERVICES = [
  {
    ...
    heroDesc: 'When it needs to arrive today, we make it happen. Go Fast Delivery Inc.\'s same-day service connects pickup and drop-off points across Calgary in under 3 hours on average, whether it\'s a single envelope or a full box of supplies.',
    stat: '< 3 hrs',
  ...
  },
  {
    ...
    heroDesc: 'Don\'t wait for a pickup window that never comes. Book your express pickup in under a minute and a nearby Go Fast Delivery Inc. driver will be at your door fast. No lengthy scheduling, no guesswork.',
    stat: '15 min',
  ...
  },
  {
    ...
    heroDesc: 'Stop rebuilding your delivery schedule from scratch every week. Go Fast Delivery Inc.\'s scheduled runs let you set it up once, daily, weekly, or custom, and we handle the rest with 99.2% on-time reliability.',
    stat: '99.2%',
