...
const STEPS = [
  ...
  },
  {
    ...
    desc: 'A verified driver picks up your package and you follow every status update in real time, from Picked Up to Delivered.',
    accent: '#ff580d',
    dim: 'rgba(255,88,13,0.08)',
    tilt: '-rotate-1',
    side: 'left',
  },
  {
    ...
    desc: 'Your package arrives at its destination fast and intact. You receive a delivery confirmation instantly.',
    accent: '#1bb908',
    dim: 'rgba(27,185,8,0.08)',
    tilt: 'rotate-1',
    side: 'right',
