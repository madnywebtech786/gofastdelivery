...
const SERVICES = [
  {
    ...
    accent: '#ff580d',
    img: 'https://images.pexels.com/photos/4391469/pexels-photo-4391469.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    accent: '#1bb908',
    img: 'https://images.pexels.com/photos/7363671/pexels-photo-7363671.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    accent: '#ff580d',
    img: 'https://images.pexels.com/photos/4246100/pexels-photo-4246100.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
  ...
  },
  {
    ...
    accent: '#1bb908',
    img: 'https://images.pexels.com/photos/5025516/pexels-photo-5025516.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    ...
    >
        ...
        <div className="flex whitespace-nowrap" style={{ animation: 'marquee-scroll 18s linear infinite' }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex items-center gap-0 shrink-0">
              {['Same-Day', 'Express', 'Business', 'Scheduled', 'Calgary', 'Fast'].map((word, i) => (
      ...
      >
        <div className="flex whitespace-nowrap" style={{ animation: 'marquee-scroll 22s linear infinite reverse' }}>
          {[...Array(3)].map((_, rep) => (
            <div key={rep} className="flex items-center gap-0 shrink-0">
              {['Reliable', '99.2% On-Time', 'Calgary', 'Same-Day', 'Trusted', '2500+ Deliveries'].map((word, i) => (
                <span key={i} className="inline-flex items-center gap-4 px-6 py-3">
                  <span
                    className="text-[10px] font-black tracking-[0.25em] uppercase"
